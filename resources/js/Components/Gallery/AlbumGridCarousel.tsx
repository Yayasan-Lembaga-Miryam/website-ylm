                            ...
                            >
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="mt-5 w-full">
                                        <h2 className="line-clamp-2 text-center text-lg font-semibold break-anywhere">
                                            {alb.judul}
                                        </h2>
                                    </div>
                                </div>
                ...
                {album.map((alb) => (
                    ...
                    >
                        ...
                        <div className="mt-5 h-[15%] w-full">
                            <h2 className="line-clamp-2 w-full text-center text-lg font-semibold break-anywhere">
                                {alb.judul}
                            </h2>
                        </div>
                    </div>
