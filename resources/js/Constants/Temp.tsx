export const newsData = [
    {
        ...
        title: 'Judul Berita 1: Perkembangan Teknologi Terbaru',
        description:
            'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque tincidunt nunc vel libero tincidunt gravida.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 2: Ekonomi Dunia Mengalami Perubahan',
        description:
            'Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 3: Kesehatan di Era Digital',
        description:
            'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 4: Pendidikan Online Meningkat',
        description:
            'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 5: Tips Mengatur Keuangan Pribadi',
        description:
            'Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 6: Perubahan Iklim dan Dampaknya',
        description:
            'Fusce dapibus tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 7: Teknologi AI di Tahun 2024',
        description:
            'Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Donec sed odio dui.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 8: Olahraga dan Kebugaran di Rumah',
        description:
            'Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Maecenas faucibus mollis interdum.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 9: Perkembangan Dunia Musik',
        description:
            'Cras mattis consectetur purus sit amet fermentum. Praesent commodo cursus magna, vel scelerisque nisl consectetur.',
    },
    {
        image: '/images/bg-LandingHome.webp',
        title: 'Judul Berita 10: Inspirasi Desain Interior Rumah',
        description:
