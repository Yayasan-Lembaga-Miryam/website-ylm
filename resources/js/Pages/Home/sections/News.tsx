...
const News = ({
    ...
    return (
        <div className="relative z-10 -mt-28 flex h-full w-full flex-col items-center justify-center gap-10 bg-[url(/images/bg-NewsHome.webp)] bg-cover bg-top bg-no-repeat pb-20 pt-[38rem] font-poppins md:gap-44 md:pb-40 md:pt-[45rem]">
